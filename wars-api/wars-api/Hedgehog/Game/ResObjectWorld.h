...
namespace hh::game {
    ...
    UCSL_NEWTYPE_STRUCT_SIMPLE(ComponentData, ucsl::resources::object_world::v2::ComponentData);
    UCSL_NEWTYPE_STRUCT_SIMPLE(ObjectTransformData, ucsl::resources::object_world::v2::ObjectTransformData);
    UCSL_NEWTYPE_STRUCT(ObjectData, ucsl::resources::object_world::v2::ObjectData<warssdk::ucsl::AllocatorSystem>, ObjectData);
    UCSL_NEWTYPE_STRUCT(ObjectWorldData, ucsl::resources::object_world::v2::ObjectWorldData<warssdk::ucsl::AllocatorSystem>, ObjectWorldData);
