...
namespace hh::gfx {
    ...
    public:
        ...
        virtual void SetFXParameter(hh::NeedleFxParameter* parameter, unsigned int unkParam1) {}
        virtual void GetFXParameter(hh::NeedleFxParameter* parameter) {}
        virtual void SetSceneConfig(hh::NeedleFxSceneConfig* sceneConfig) {}
        virtual void GetSceneConfig(hh::NeedleFxSceneConfig* sceneConfig) {}
